...
def _paper_groups_prompt(projects: list[dict], *, compact: bool = False) -> str:
    ...
    return (
        ...
        "- Each group must contain **10–30 paper_keys** (minimum 10, maximum 30). "
        "Split oversized themes into multiple 10–30 paper sets rather than one huge list.\n"
        "- Minimize standalone papers: place every paper you can into a valid 10–30 paper "
        "set before leaving it ungrouped.\n"
        "- Groups may span multiple projects when papers share themes, methods, or goals; "
        "a single Zotero collection with 10–30 papers may also form one set.\n"
